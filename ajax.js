...
$(document).ready(function(){
	...
	$("#Proviance").change(function(){
		$("#Subdistrict").html("<option value=\"0\" selected=\"selected\">--- เลือกตำบล ---</option>");//ล้างข้อมูล
		$("#Postcode").html("<option value=\"0\" selected=\"selected\">--- เลือกรหัสไปรษณีย์ ---</option>");//ล้างข้อมูล
